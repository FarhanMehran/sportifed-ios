...
struct SquashScoreCardsView: View {
...
//                        }
                    ...
                    HStack(spacing: 2){
                        Text("Serve side").font(Font.mulishBold(size: 18)).foregroundColor(Color.textColor)
                        Text("").font(Font.mulishMedium(size: 18)).foregroundColor(Color.red)
                            .frame(maxWidth: .infinity,alignment: .leading)
                    }
                    ...
                    HStack(spacing: 2){
                        Text("Error").font(Font.mulishBold(size: 18)).foregroundColor(Color.textColor)
                        Text("").font(Font.mulishMedium(size: 18)).foregroundColor(Color.red)
                            .frame(maxWidth: .infinity,alignment: .leading)
                    }
                    ...
                    HStack(spacing: 2){
                        Text("Rally").font(Font.mulishBold(size: 18)).foregroundColor(Color.textColor)
                        Text("").font(Font.mulishMedium(size: 18)).foregroundColor(Color.red)
                            .frame(maxWidth: .infinity,alignment: .leading)
                    }
                    ...
                    SetCardView(title: "Points won in current game")
                    HStack{
                        ButtonCardView()
                        Spacer()
                        ButtonCardView()
...
#Preview {
    SquashScoreCardsView(viewModel: TennisScoreCardViewModel())
}
