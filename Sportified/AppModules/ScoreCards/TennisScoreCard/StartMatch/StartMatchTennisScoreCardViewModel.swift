//
//  StartMatchTennisScoreCardViewModel.swift
//  Sportified
//
...
import Foundation
class StartMatchTennisScoreCardViewModel: BaseViewModel {
    ...
    @Published  var matchFormatList:[SelectedDate] = [SelectedDate(name: "Singles", isSelected: false),
                                                      ...
                                                      SelectedDate(name: "Mixed Doubles", isSelected: false)]
    
    @Published var serverReceiver : String? = nil
    @Published var isShowServerReceiver : Bool = false
    @Published  var serverReceiverList:[SelectedDate] = [SelectedDate(name: "Serve First", isSelected: false),
                                                      SelectedDate(name: "Receive First", isSelected: false)]
    ...
    @Published var courtNumberList:[SelectedDate] = [SelectedDate(name: "Grass", isSelected: false),
                                                      SelectedDate(name: "Clay", isSelected: false),
                                                      SelectedDate(name: "Hard", isSelected: false),
                                                      SelectedDate(name: "Carpet (Indoor)", isSelected: false)]
