//
//  TennisScoreCardSummaryView.swift
//  Sportified
//
...
struct TennisScoreCardSummaryView: View {
...
//                        Text("Full Time") .foregroundColor(.appGreenColor) .font(.mulishRegular(size: 12)).padding(.top,2)
                ...
                ///Game Details:
                HStack{
                    Text("Set Details: ") .foregroundColor(.textColor) .font(.mulishBold(size: 20))
                    Spacer()
                ...
                if !viewModel.goleLsit.isEmpty{
                    ZStack{
                        VStack(spacing:0){
                            HStack{
                                Spacer()
                                Text("Set") .foregroundColor(.white) .font(.mulishBold(size: 15))
                                Spacer()
                                Text("Player 1") .foregroundColor(.white) .font(.mulishBold(size: 15)).padding(.leading,20).offset(x: 10)
                                Spacer()
                                Text("Player 2") .foregroundColor(.white) .font(.mulishBold(size: 15)).padding(.leading,20).offset(x: 5)
                                Spacer()
                    ...
                    ZStack{
                        VStack(spacing:0){
                            HStack{
                                ...
                                Spacer()
                                Text("Player 1") .foregroundColor(.white) .font(.mulishBold(size: 15)).padding(.leading,20).offset(x: -20)
                                Spacer()
...
#Preview {
    TennisScoreCardSummaryView(viewModel: SquashScoreCardsSummaryViewModel())
}
