//
//  BasketballScoreCardSummaryView.swift
//  Sportified
//
...
struct BasketballScoreCardSummaryView: View {
    @ObservedObject var viewModel: FootballScoreCardSummaryViewModel
    var body: some View {
        ScrollView(showsIndicators: false){
            VStack(spacing:0){
                
                HomeSecondaryAppBBar(title: "Basketball Score Card", btnShareCallBack:  {
...
#Preview {
    BasketballScoreCardSummaryView(viewModel: FootballScoreCardSummaryViewModel())
}
