//
//  FootballScoreCardSummaryViewModel.swift
//  Sportified
//
//  Created by Tariq Mahmood   on 04/08/2024.
//

import Foundation
class FootballScoreCardSummaryViewModel: BaseViewModel {
...
func parseTime(_ timeString: String?) -> Int {
    // Parsing time from string, stripping the apostrophe and converting to an integer
    guard let timeString = timeString, let time = Int(timeString.replacingOccurrences(of: "'", with: "")) else {
        return 0
    }
    return time
}
